...
from models.emaunet import LEMAUNet
...
def main(datasets, checkpoint_path):
    ...
    model = LEMAUNet(num_classes=model_cfg['num_classes'],
...
if __name__ == '__main__':
    datasets = 'isic17'
    checkpoint_path = './results/17-84.20/checkpoints/best-epoch274-loss0.3056.pth'
    # checkpoint_path = './results/17-84.17/checkpoints/best-epoch281-loss0.3033.pth'
